...
from .google_calendar import iniciar_google_calendar, criar_evento, deletar_evento
...
class TaskAPIView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            task.google_event_id = evento_id
            task.save()
    ...
    def delete(self, request, pk):
        ...
        if task.google_event_id:
            deletar_evento(self.calendar_service, task.google_event_id)
